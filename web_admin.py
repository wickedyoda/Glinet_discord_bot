...
INT_KEYS = {
    ...
    "FRESHDESK_ADMIN_ROLE_ID",
    "FRESHDESK_USER_ROLE_ID",
...
def create_web_app(
    ...
    def _on_get_freshdesk_env():
        ...
        return {
            ...
            "FRESHDESK_ADMIN_ROLE_ID": env_vals.get("FRESHDESK_ADMIN_ROLE_ID", "0"),
            "FRESHDESK_USER_ROLE_ID": env_vals.get("FRESHDESK_USER_ROLE_ID", "0"),
        }
...
def start_web_admin_interface(
    ...
    app = create_web_app(
        ...
        on_get_translate_channels=on_get_translate_channels,
        on_manage_translate_channels=on_manage_translate_channels,
