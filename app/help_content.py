...
HELP_COMMAND_ALIASES = {
    ...
    "freshdesk_search": "freshdesk_search",
    "freshdeskssearch": "freshdesk_search",
    "freshdesk-ticket": "freshdesk_ticket",
    "freshdesk_ticket": "freshdesk_ticket",
    "freshdeskticket": "freshdesk_ticket",
    "freshdesk_categories": "freshdesk_categories",
    "freshdeskcategories": "freshdesk_categories",
...
HELP_WIKI_PAGE_BY_COMMAND = {
    ...
    "freshdesk_search": ["Freshdesk-Integration.md", "Command-Reference.md"],
    "freshdesk_ticket": ["Freshdesk-Integration.md", "Command-Reference.md"],
    "freshdesk_categories": ["Freshdesk-Integration.md", "Command-Reference.md"],
    ...
    if not normalized_command:
        return "\n".join(
            [
                ...
                "- Search (`/search_reddit`, `/search_forum`, `/search_openwrt_forum`, `/search_kvm`, `/search_iot`, `/search_router`, `/search_astrowarp`, `/freshdesk-search`)",
